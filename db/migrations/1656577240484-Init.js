module.exports = class Init1656577240484 {
  name = 'Init1656577240484'

  async up(db) {
    await db.query(`CREATE TABLE "tvl_chart" ("id" character varying NOT NULL, "id_int" integer NOT NULL, "current_timestamp" numeric NOT NULL, "end_timestamp" numeric NOT NULL, "a_lp_amount" numeric NOT NULL, "a_lp_address" text NOT NULL, "lp_price" text array NOT NULL, "tx_hash" text NOT NULL, "block" integer NOT NULL, CONSTRAINT "PK_f66cd7d4c33771e532ab8517aa1" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "lp_price" ("id" character varying NOT NULL, "id_int" integer NOT NULL, "lp_price" text NOT NULL, "lp_address" text NOT NULL, "lp_symbol" text NOT NULL, "lp_price_symbol" text NOT NULL, "event" text NOT NULL, "block" integer NOT NULL, "tx_hash" text NOT NULL, CONSTRAINT "PK_3f04d144163b67ae9788d05b435" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "token_price" ("id" character varying NOT NULL, "id_int" integer NOT NULL, "token_price" text NOT NULL, "token_address" text NOT NULL, "token_symbol" text NOT NULL, "event" text NOT NULL, "block" integer NOT NULL, "tx_hash" text NOT NULL, CONSTRAINT "PK_dcc681716689f0d6311c0498c61" PRIMARY KEY ("id"))`)
  }
