module.exports = class Init1660888809596 {
  name = 'Init1660888809596'

  async up(db) {
    await db.query(`CREATE TABLE "tvl_chart" ("id" character varying NOT NULL, "id_int" integer NOT NULL, "current_timestamp" numeric NOT NULL, "end_timestamp" numeric NOT NULL, "total_a_lp_amount_usd" text NOT NULL, "a_lp_amount" text NOT NULL, "a_lp_amount_usd" text NOT NULL, "a_lp_address" text NOT NULL, "lp_price" text NOT NULL, "tx_hash" text NOT NULL, "block" integer NOT NULL, CONSTRAINT "PK_f66cd7d4c33771e532ab8517aa1" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "lp_token_amount" ("id" character varying NOT NULL, "id_int" integer NOT NULL, "token" text NOT NULL, "token1" text NOT NULL, "token_amount" text NOT NULL, "token1_amount" text NOT NULL, "block" integer NOT NULL, "tx_hash" text NOT NULL, "lp_address" text NOT NULL, "event" text NOT NULL, CONSTRAINT "PK_bd4293964632e8f48a9e553568c" PRIMARY KEY ("id"))`)
