...
const KAC_wSDN_lp = {
  ...
  quoteToken: tokens.sdn.symbol,
  quoteTokenAddress: tokens.sdn.address,
  quoteTokenDecimals: tokens.sdn.decimals,
};
const wSDN_USDC_lp = {
  ...
  token: tokens.sdn.symbol,
  tokenAddress: tokens.sdn.address,
  tokenDecimals: tokens.sdn.decimals,
  quoteToken: tokens.usdc.symbol,
  quoteTokenAddress: tokens.usdc.address,
  quoteTokenDecimals: tokens.usdc.decimals,
};
const ETH_wSDN_lp = {
  ...
  token: tokens.eth.symbol,
  tokenAddress: tokens.eth.address,
  tokenDecimals: tokens.eth.decimals,
  quoteToken: tokens.sdn.symbol,
  quoteTokenAddress: tokens.sdn.address,
  quoteTokenDecimals: tokens.sdn.decimals,
};
...
const BUSD_USDC_lp = {
  ...
  token: tokens.busd.symbol,
  tokenAddress: tokens.busd.address,
  tokenDecimals: tokens.busd.decimals,
  quoteToken: tokens.usdc.symbol,
  quoteTokenAddress: tokens.usdc.address,
  quoteTokenDecimals: tokens.usdc.decimals,
};
const wSDN_JPYC_lp = {
  ...
  tokenAddress: tokens.sdn.address,
  tokenDecimals: tokens.sdn.decimals,
  quoteToken: tokens.jpyc.symbol,
  quoteTokenAddress: tokens.jpyc.address,
  quoteTokenDecimals: tokens.jpyc.decimals,
};
const JPYC_USDC_lp = {
  ...
  token: tokens.jpyc.symbol,
  tokenAddress: tokens.jpyc.address,
  tokenDecimals: tokens.jpyc.decimals,
  quoteToken: tokens.usdc.symbol,
  quoteTokenAddress: tokens.usdc.address,
  quoteTokenDecimals: tokens.usdc.decimals,
};
...
//   "quoteToken": "sdn",
//   "quoteTokenAmount": "3.169999999999999929",
//   "token": "kac",
